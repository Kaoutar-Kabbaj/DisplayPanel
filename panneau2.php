...
include('../'.$directory.'/includes/fusioncharts.php');
...
<head>
    ...
    <link rel="stylesheet" href="css/style_css_panneau.css">
...
//        $id_user = 30;
        ...
        //test if id_user exist in tab array
    ...
    <div class="row">
        ...
        <div class="col-6" id="div_dashboard" style="margin-bottom: 10%;">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <center><b><h1 style=" color: white; font-size: 250%;"><?= $titre1 ; ?></h1></b></center>
                        <center><h4 style=" color: white;"><?= $titre2;   ?>
                         <br><br>
                        </center>
                        </h4>
                     </div>
