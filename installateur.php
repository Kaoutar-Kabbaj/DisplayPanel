...
if (isset($_SESSION['username'])){
    ...
    $sql = "SELECT * FROM user WHERE id_user like '$id_installateur'";
    ...
    <div class="main-panel">
        ...
        <nav class="navbar navbar-expand-lg " color-on-scroll="500">
            <div class="container-fluid">
                <a class="navbar-brand" href="#pablo"> Installateur </a>
                            ...
                            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form method="POST" action="upload_installateur.php" enctype="multipart/form-data">
...
<?php
$sql ="SELECT `logo_user` FROM `user` WHERE `id_user` like '$id_installateur'";
$result = $conn->query($sql);
