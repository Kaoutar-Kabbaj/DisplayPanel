        ...
        <div class="sidebar-wrapper">
            ...
            <ul class="nav">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="./espace2.php">
                                    ...
                                    <fieldset>
                                        <div class="form-row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"  placeholder="Production actuelle" name="titre1" value="<?php echo $titre1;?>" />                                                    </div>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group">
                                                ...
                                                <input type="text"  class="form-control" placeholder="Ce batiment utilise de l'energie solaire" name="titre2" value="<?php echo $titre2;?>">
                                            </div>
                                            <div class="form-group">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="container center" style="box-shadow: 0px 3px 9.5px 0.5px rgba(0, 0, 0, 0)" >
                                            <form method="POST" action=update_para.php" enctype="multipart/form-data">
                                                    ...
                                                    <label> Veuillez choisir la couleur de votre arrière plan</label>
<br>
                                                        <input type="color"  class="form-control" value="<?= $color;?>" name="textcolor">
